...
const { time, expectRevert, send, ether } = require("@openzeppelin/test-helpers");
...
contract("RToken", accounts => {
    ...
    before(async () => {
        ...
        ////// OUR UPDATES BELOW
        const rTokenAddress = proxy.address;
        console.log('rToken Address: ', rTokenAddress);

        daiAddress = await cToken.underlying();
        console.log('dai Address: ', daiAddress);
        tokenAddress = token.address;
        console.log('tokenAddress: ', tokenAddress);
        const molochDeploy = await Moloch.new(
          admin,
          daiAddress,
          17280,
          35,
        ...
        await web3tx(token.mint, "token.mint 10000 -> account0")(accounts[0], toWad(10000), { from: admin });
        await web3tx(token.mint, "token.mint 50000 -> account1")(accounts[1], toWad(50000), { from: admin });
        await web3tx(token.mint, "token.mint 99000 -> account2")(accounts[2], toWad(99000), { from: admin });

        console.log('do approvals...');
    ...
    async function expectAccount(account, balances, decimals) {
        ...
        else if (account === bingeBorrower) accountName = "customer2";
    ...
    it("rToken setup", async() => {});

    it.skip("#0 initial test condition", async () => {
    ...
    it.skip("#2 normal operations with zero hatter", async () => {
    ...
    it.skip("#3 normal operations with hat", async () => {
    ...
    it.skip("#4 mint multiple times", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(
            rToken.address, toWad(100), { from: customer1 });
    ...
    it.skip("#5 redeem all including paid interest from single hat", async () => {
    ...
    it.skip("#6 transfer and switch hats", async () => {
    ...
    it.skip("#7 redeem all including paid interest from zero hatter", async () => {
    ...
    it.skip("#9 normal operations with self hatter", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(
            rToken.address, toWad(100), { from: customer1 });
    ...
    it.skip("#10 CompoundAs ownership protection", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(
            rToken.address, toWad(100), { from: customer1 });
        await web3tx(rToken.mintWithSelectedHat, "rToken.mintWithSelectedHat 100 to customer1 with the self hat")(
            toWad(100), await rToken.SELF_HAT_ID.call(), { from: customer1 });
    ...
    it.skip("#12 redeem all including paid interest from multiple hats", async () => {
    ...
    it.skip("#13 approve & transferFrom & transferAllFrom", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(rToken.address, toWad(100), {
            from: customer1
        });
        await web3tx(rToken.mintWithSelectedHat, "rToken.mintWithSelectedHat 100 to customer1 with the self hat")(
    ...
    it.skip("#14 redeemAndTransferAll", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(
            rToken.address, toWad(100), { from: customer1 });
        await web3tx(rToken.mintWithSelectedHat, "rToken.mintWithSelectedHat 100 to customer1 with the self hat")(
            toWad(100), await rToken.SELF_HAT_ID.call(), { from: customer1 });
    ...
    it.skip("#15 upgrade contract", async () => {
    ...
    it.skip("#16 proxy security", async () => {
        // admin
    ...
    it.skip("#17 storage continuity during upgrade", async () => {
    ...
    it.skip("#18 admin.changeHatFor", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(rToken.address, toWad(100), {
            from: customer1
        });
        await web3tx(rToken.mintWithNewHat, "rToken.mint 100 to customer1 with a hat benefiting admin(90%) and customer2(10%)")(
    ...
    it.skip("#19 Max hat numbers & same hat optimization", async () => {
        let tx;
    ...
    it.skip("#20 change hat with invalid hat ID should fail", async () => {
        await expectRevert(rToken.changeHat(42), "Invalid hat ID");
    });

    it.skip("#21 create invalid hats", async () => {
    ...
    it.skip("#22 change allocation strategy multiple times", async () => {
    ...
    it.skip("#23 change hat test", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(rToken.address, toWad(100), {
            from: customer1
        });
    ...
    it.skip("#23 change hat test w/ 2 recipients", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(rToken.address, toWad(100), {
            from: customer1
        });
        await web3tx(rToken.mintWithNewHat, "rToken.mint 100 to customer1 with a hat benefiting customer2(100%)")(
    ...
    it.skip("#24 complex functional test", async () => {
    ...
    it.skip("#25 change allocation strategy multiple times", async () => {
        let compoundAS2;
        {
            const result = await createCompoundAllocationStrategy(toWad(1));
            compoundAS2 = result.compoundAS;
    ...
    it.skip("#27 normal operations with self-recipient hatter", async () => {
        await web3tx(token.approve, "token.approve 100 by customer1")(rToken.address, toWad(100), {
            from: customer1
        });
        await expectRevert(rToken.mintWithSelectedHat(toWad(1), 1), "Invalid hat ID");
